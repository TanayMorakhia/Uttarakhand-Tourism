...
class Mussorie extends StatelessWidget {
  const Mussorie({Key? key}) : super(key: key);
      ...
      body: ListView(
        children: [
            ...
            children: [
              Padding(
                ...
                child: CircleAvatar(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, MyRoutes.hotelMussorieRoute);
                    },
                    child: Text(
                      "Hotels",
          ...
          Padding(
            ...
            child: Text(
              "Mussoorie, known as the Queen of the Hills, and famous for its scenic beauty, is a fascinating hill resort. It commands a wonderful view of the extensive Himalayan snow ranges in the north-west and glittering views of the Doon Valley. ",
              style: TextStyle(
                fontSize: 15,
